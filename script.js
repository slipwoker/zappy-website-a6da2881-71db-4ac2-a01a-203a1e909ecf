document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field) {
      ...
      if (type === 'email' && !validators.email(field.value)) {
        return 'Please enter a valid email address.';
      }
      if (type === 'tel' && !validators.tel(field.value)) {
        return 'Please enter a valid phone number.';
      }
      const minLen = parseInt(field.dataset.minLength, 10);
      if (minLen && !validators.minLength(field.value, minLen)) {
        return fieldLabel + ' must be at least ' + minLen + ' characters.';
      }
      return '';
    }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successFields = contactForm.querySelectorAll('.input-success');
  ...
  const ANIMATION_SELECTORS = '.animate-on-scroll, .fade-in, .slide-up, .reveal';
  ...
  style.textContent = [
    ...
    '.input-error{border-color:#e53e3e !important;box-shadow:0 0 0 2px rgba(229,62,62,0.2);}',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "muziaeliki2026 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a6da2881-71db-4ac2-a01a-203a1e909ecf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a6da2881-71db-4ac2-a01a-203a1e909ecf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a6da2881-71db-4ac2-a01a-203a1e909ecf';
